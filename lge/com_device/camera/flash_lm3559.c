...
//Start LGE_BSP_CAMERA : Separate Flash stae for only DOCOMO : modified for Batman DCM : 2012-05-02 - jungki.kim@lge.com
#ifdef CONFIG_MACH_LGE_325_BOARD_DCM
#define LM3559_LED_MOVIE	5
#define LM3559_STATE_ON_MOVIE  5
#endif
//End  LGE_BSP_CAMERA : Separate Flash stae for only DOCOMO : modified for Batman DCM : 2012-05-02 - jungki.kim@lge.com
...
//LGE_BSP_CAMERA_S::jungki.kim@lge.com  2012-05-29  Batman_DCM sometimes does not turn off the Flash.
...
//LGE_BSP_CAMERA_E::jungki.kim@lge.com  2012-05-29  Batman_DCM sometimes does not turn off the Flash.
...
static struct i2c_driver lm3559_driver = {
	...
	.shutdown = lm3559_shutdown,	// LGE_BSP_CAMERA::jungki.kim@lge.com  2012-05-29  Batman_DCM sometimes does not turn off the Flash.
	.id_table = lm3559_ids,
	.driver   = {
