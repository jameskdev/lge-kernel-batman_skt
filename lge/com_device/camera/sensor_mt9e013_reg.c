...
#if 0	// LGE_BSP_CAMERA_S::jungki.kim@lge.com  2012-06-19  Reduce Blinking On Starting Camera
	{0x0202, 0x055F},/*COARSE_INTEGRATION_TIME*/
#else
	{0x0202, 0x00CF},/*COARSE_INTEGRATION_TIME*/
	{0x0204, 0x0060},
#endif 	// LGE_BSP_CAMERA_E::jungki.kim@lge.com  2012-06-19  Reduce Blinking On Starting Camera
