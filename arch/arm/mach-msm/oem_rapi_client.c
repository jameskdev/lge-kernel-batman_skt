...
#if defined (CONFIG_MACH_LGE_I_BOARD_LGU) || defined (CONFIG_MACH_LGE_I_BOARD_VZW) || defined (CONFIG_MACH_LGE_325_BOARD_VZW)
#define OEM_RAPI_PROG  0x3000006B
#elif defined (CONFIG_MACH_LGE_I_BOARD_SKT) || defined (CONFIG_MACH_LGE_I_BOARD_ATNT) || defined (CONFIG_MACH_LGE_I_BOARD_DCM) || defined(CONFIG_MACH_LGE_325_BOARD_DCM) || defined(CONFIG_MACH_LGE_325_BOARD_SKT)
