...
#endif
#endif	      //LGE_CHANGE_S, [jaewoo.hwang@lge.com], 2012-06-18, <Broadcom Patch>
...
#ifndef CONFIG_LGE_BCM432X_PATCH   //LGE_CHANGE_S, [jaewoo.hwang@lge.com], 2012-06-21, <Broadcom Patch>
			dev_close(dev); 
			dev_open(dev);
#endif   //LGE_CHANGE_E, [jaewoo.hwang@lge.com], 2012-06-21, <Broadcom Patch>
#endif
		}
	}
	return ret;
