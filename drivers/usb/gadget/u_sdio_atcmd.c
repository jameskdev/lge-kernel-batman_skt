...
#if defined(CONFIG_MACH_LGE_I_BOARD_LGU) || defined(CONFIG_MACH_LGE_325_BOARD_LGU)
...
#elif defined (CONFIG_MACH_LGE_I_BOARD_SKT) || defined (CONFIG_MACH_LGE_325_BOARD_SKT)
